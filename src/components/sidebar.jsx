  ...
  return ( 
    <div className="fixed top-0 left-0 h-screen w-36 m-0
      ...
      <div className="contents">
        <SidebarIcon icon={home} pageName="Home" />
        <SidebarIcon icon={projects} pageName="Coding Projects" />
        <SidebarIcon icon={gis} pageName="GIS Projects" />
        <SidebarIcon icon={weather} pageName="Whats The Weather" />
        <SidebarIcon icon={resume} pageName="Resume" />
      </div>
